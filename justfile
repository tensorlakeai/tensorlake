...
test-sandbox-connect-python:
    PYTHONPATH=src poetry run python -m unittest tests.sandbox.test_connect_ready tests.sandbox.test_client_rust_backend tests.sandbox.test_client_rust_backend_async tests.sandbox.test_sandbox_rust_backend tests.sandbox.test_sandbox_rust_backend_async tests.sandbox.test_file_systems tests.sandbox.test_get_or_create tests.image.test_sandbox_builder tests.function_agent.test_runner
