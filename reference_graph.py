...
import tensorlake
from tensorlake import tensorlake_function, Graph, Image, Client
...
summer = Graph(name="sequence_summer", start_node=map_function, description="Simple Sequence Summer")
