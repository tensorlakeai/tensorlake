...
class TensorlakeClient:
    ...
    def register_compute_graph(self, graph: Graph, additional_modules, upgrade_tasks_to_latest_version=False):
        ...
        response = self._post(
            ...
            data={"compute_graph": graph_metadata.model_dump_json(exclude_none=True), "upgrade_tasks_to_latest_version": upgrade_tasks_to_latest_version},
        )
