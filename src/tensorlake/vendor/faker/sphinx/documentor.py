...
from tensorlake.vendor.faker.config import AVAILABLE_LOCALES
from tensorlake.vendor.faker.config import PROVIDERS as STANDARD_PROVIDER_NAMES
from tensorlake.vendor.faker.providers import BaseProvider
