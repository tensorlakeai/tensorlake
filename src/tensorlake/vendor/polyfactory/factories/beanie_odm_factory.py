...
from tensorlake.vendor.polyfactory.persistence import AsyncPersistenceProtocol
from tensorlake.vendor.polyfactory.utils.predicates import is_safe_subclass

if TYPE_CHECKING:
    from typing_extensions import TypeGuard

    from tensorlake.vendor.polyfactory.factories.base import BuildContext
    from tensorlake.vendor.polyfactory.field_meta import FieldMeta
