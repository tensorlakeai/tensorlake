...
from tensorlake.vendor.faker import Faker
from typing_extensions import Self, get_args, get_origin, get_original_bases

from tensorlake.vendor.polyfactory.constants import (
    DEFAULT_RANDOM,
    MAX_COLLECTION_LENGTH,
    MIN_COLLECTION_LENGTH,
    RANDOMIZE_COLLECTION_LENGTH,
)
from tensorlake.vendor.polyfactory.exceptions import ConfigurationException, MissingBuildKwargException, ParameterException
from tensorlake.vendor.polyfactory.field_meta import Null
from tensorlake.vendor.polyfactory.fields import Ignore, PostGenerated, Require, Use
from tensorlake.vendor.polyfactory.utils.helpers import (
    flatten_annotation,
    get_collection_type,
    unwrap_annotation,
    unwrap_args,
...
from tensorlake.vendor.polyfactory.utils.model_coverage import CoverageContainer, CoverageContainerCallable, resolve_kwargs_coverage
from tensorlake.vendor.polyfactory.utils.predicates import (
    get_type_origin,
    is_forward_ref,
    is_literal,
    is_optional,
...
from tensorlake.vendor.polyfactory.utils.types import NoneType
from tensorlake.vendor.polyfactory.value_generators.complex_types import handle_collection_type, handle_collection_type_coverage
from tensorlake.vendor.polyfactory.value_generators.constrained_collections import (
    handle_constrained_collection,
    handle_constrained_mapping,
)
from tensorlake.vendor.polyfactory.value_generators.constrained_dates import handle_constrained_date
from tensorlake.vendor.polyfactory.value_generators.constrained_numbers import (
    handle_constrained_decimal,
    handle_constrained_float,
    handle_constrained_int,
)
from tensorlake.vendor.polyfactory.value_generators.constrained_path import handle_constrained_path
from tensorlake.vendor.polyfactory.value_generators.constrained_strings import handle_constrained_string_or_bytes
from tensorlake.vendor.polyfactory.value_generators.constrained_url import handle_constrained_url
from tensorlake.vendor.polyfactory.value_generators.constrained_uuid import handle_constrained_uuid
from tensorlake.vendor.polyfactory.value_generators.primitives import create_random_boolean, create_random_bytes, create_random_string

if TYPE_CHECKING:
    from typing_extensions import TypeGuard

    from tensorlake.vendor.polyfactory.field_meta import Constraints, FieldMeta
    from tensorlake.vendor.polyfactory.persistence import AsyncPersistenceProtocol, SyncPersistenceProtocol
...
def _register_builtin_factories() -> None:
    ...
    :returns: None
    """
    import tensorlake.vendor.polyfactory.factories.dataclass_factory
    import tensorlake.vendor.polyfactory.factories.typed_dict_factory  # noqa: F401
