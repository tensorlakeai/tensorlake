...
class RequestStateHTTPClient(RequestState):
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        # type_hints=[] because pickle serializer knows the target type already.
    ...
    def get(self, key: str, default: Any | None = None) -> Any | None:
        ...
        # Raises SerializationError to customer code on failure.
        # type_hints=[] because pickle deserializer knows the target type already.
        return REQUEST_STATE_USER_DATA_SERIALIZER.deserialize(
            serialized_value, type_hints=[]
        )
