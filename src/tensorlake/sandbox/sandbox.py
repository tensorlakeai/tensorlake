...
class Sandbox:
    ...
    def detach_file_system(self, mount_path: str) -> Traced[SandboxInfo]:
        ...
        traced = self._lifecycle_client.detach_file_system(
    ...
    def list_file_systems(self) -> list[FileSystemMount]:
