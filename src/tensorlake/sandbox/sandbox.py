...
class Sandbox:
    ...
    def create(
        ...
        Args:
            ...
            filesystems: Filesystems to mount into the sandbox
    ...
    def attach_filesystem(
        ...
        traced = self._lifecycle_client.attach_filesystem(
    ...
    def detach_filesystem(self, mount_path: str) -> Traced[SandboxInfo]:
        ...
        traced = self._lifecycle_client.detach_filesystem(
    ...
    def list_filesystems(self) -> list[FilesystemMount]:
