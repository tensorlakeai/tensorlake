...
class RemoteGraph:
    ...
    def run(self, request: Any, block_until_done: bool = False) -> str:
        ...
        :param request: The input for the start function of the graph.
        :param block_until_done: If True, the function will block until the graph execution is complete.
        :return: The request ID of the graph execution.
        ...
        Example:
            ...
            invocation_id = remote_graph.run(1)
        """
    ...
    def stream(self, request: Any) -> Generator[WorkflowEvent, None, str]:
        """
        ...
        Example:
            ...
            remote_graph = RemoteGraph.by_name("test")
            for event in remote_graph.stream(1):
                print(event)
        """
