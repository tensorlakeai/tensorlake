...
# source: tensorlake/function_executor/proto/status.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'tensorlake/function_executor/proto/status.proto'
)
