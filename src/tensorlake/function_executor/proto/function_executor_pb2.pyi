...
class SerializedObjectManifest(_message.Message):
    ...
    def __init__(
        ...
        chunk_count: _Optional[int] = ...,
    ) -> None: ...

class SerializedObjectChunk(_message.Message):
    __slots__ = ("id", "data", "index")
    ID_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NUMBER: _ClassVar[int]
...
class RunTaskAllocationsSessionClientMessage(_message.Message):
    ...
    CLOSE_SESSION_REQUEST_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        close_session_request: _Optional[_Union[CloseSessionRequest, _Mapping]] = ...,
    ) -> None: ...
...
class OpenSessionResponse(_message.Message):
    ...
    is_new: bool
    def __init__(
        self, status: _Optional[_Union[Status, _Mapping]] = ..., is_new: bool = ...
    ) -> None: ...
...
class RunTaskAllocationsSessionServerMessage(_message.Message):
    ...
    CLOSE_SESSION_RESPONSE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        close_session_response: _Optional[_Union[CloseSessionResponse, _Mapping]] = ...,
    ) -> None: ...
