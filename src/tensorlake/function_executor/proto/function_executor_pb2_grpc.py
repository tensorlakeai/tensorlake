...
from tensorlake.function_executor.proto import function_executor_pb2 as tensorlake_dot_function__executor_dot_proto_dot_function__executor__pb2
...
def add_FunctionExecutorServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('function_executor_service.FunctionExecutor', rpc_method_handlers)
...
class FunctionExecutor(object):
    ...
    @staticmethod
    def watch_allocation_state(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def send_allocation_update(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
