...
# source: tensorlake/function_executor/proto/google/rpc/status.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    "",
    "tensorlake/function_executor/proto/google/rpc/status.proto",
)
