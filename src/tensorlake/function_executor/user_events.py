    ...
    print_cloud_event(
        {
            ...
            "application_version": details.application_version,
            "function": details.function_name,
            "error": _clean_bootstrap_stack_trace(error),
        }
    )


def _clean_bootstrap_stack_trace(error: BaseException) -> list[str]:
    """
    ...
    If the error was not generated by the `importlib._bootstrap` module,
    we return an empty list because it's an undefined behavior.
    """
