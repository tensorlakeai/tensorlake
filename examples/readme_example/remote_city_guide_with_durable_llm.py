...
def main():
    """
    Tests invoking the city_guide_with_durable_llm_app application remotely on Tensorlake Cloud.
    """
    city = "Milan, Italy"
    print(f"Invoking city_guide_with_durable_llm_app remotely for city: {city}\n")
    ...
    try:
        ...
        request = run_remote_application("city_guide_with_durable_llm_app", city)
