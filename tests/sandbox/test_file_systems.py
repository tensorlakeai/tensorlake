...
class TestFileSystemModels(unittest.TestCase):
    ...
    def test_create_request_serializes_file_systems(self):
...
class TestFileSystemRegistry(unittest.TestCase):
    ...
    def test_create_file_system(self):
        ...
        with patch(
            "tensorlake.sandbox.file_system._cloud_api_client", return_value=fake
        ):
            fs = create_file_system("skills", description="shared skills volume")
