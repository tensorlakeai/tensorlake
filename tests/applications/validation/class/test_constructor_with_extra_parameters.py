...
class TestConstructorWithExtraParameters(unittest.TestCase):
    def test_applications_fail_validation(self):
        ...
        self.assertEqual(
            ...
            "'MyClass.__init__' can only have a single 'self' parameter. Please remove the rest of the parameters.",
        )
