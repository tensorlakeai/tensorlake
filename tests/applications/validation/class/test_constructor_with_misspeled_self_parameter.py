...
class TestConstructorWithMisspeledSelfParameter(unittest.TestCase):
    def test_applications_fail_validation(self):
        ...
        self.assertEqual(
            ...
            "'MyClass.__init__' should have its first parameter named 'self'. Please rename the first parameter to 'self'.",
        )
