...
@application(output_serializer="not_supported_serializer")
@function()
def application_function(foo: int) -> int:
    return foo


class TestNotSupportedOutputSerializer(unittest.TestCase):
    def test_fails_validation(self):
        ...
        self.assertEqual(
            "Application function uses not supported output serializer 'not_supported_serializer'. "
