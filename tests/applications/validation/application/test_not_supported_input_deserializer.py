...
@application(input_deserializer="not_supported_deserializer")
@function()
def application_function(foo: int) -> int:
    return foo


class TestNotSupportedInputDeserializer(unittest.TestCase):
    def test_fails_validation(self):
        ...
        self.assertEqual(
            "Application function uses not supported input deserializer 'not_supported_deserializer'. "
