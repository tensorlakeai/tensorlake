...
@application()
@function()
def application_function_keyword_only(*, foo: int) -> int:
    return foo


class TestKeywordOnlyParameterKind(unittest.TestCase):
    def test_fails_validation(self):
        ...
        self.assertEqual(
            f"Application function parameter 'foo' has unsupported parameter kind 'keyword-only'. "
        ...
        self.assertEqual(
            ...
            "application_function_keyword_only",
        )
