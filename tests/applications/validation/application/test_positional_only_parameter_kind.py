...
@application()
@function()
def application_function_positional_only(foo: int, /) -> int:
    return foo


class TestPositionalOnlyParameterKind(unittest.TestCase):
    def test_fails_validation(self):
        ...
        self.assertEqual(
            f"Application function parameter 'foo' has unsupported parameter kind 'positional-only'. "
        ...
        self.assertEqual(
            ...
            "application_function_positional_only",
        )
